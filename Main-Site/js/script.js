...
var appMaster = {
    ...
    animateScript: function() {
        // 直接显示所有内容，不再使用滚动触发动画
        $('.scrollpoint.sp-effect1').addClass('active animated fadeInLeft');
        $('.scrollpoint.sp-effect2').addClass('active animated fadeInRight');
        $('.scrollpoint.sp-effect3').addClass('active animated fadeInDown');
        $('.scrollpoint.sp-effect4').addClass('active animated fadeIn');
        $('.scrollpoint.sp-effect5').addClass('active animated fadeInUp');
        $('.scrollpoint.sp-effect6').addClass('active animated bounceIn');
    },
